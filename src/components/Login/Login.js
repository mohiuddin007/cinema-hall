          ...
          <Navbar/>
           ...
           <div className="row justify-content-center">
                <div className="col-md-6 border border-secondary rounded loginCard">
                    <span className="rounded mx-auto d-block"><img src="https://i.ibb.co/7trMs8t/cinema-hall-logo.jpg" className="logoSizing" alt="logo"/></span>
                     <h1>Login With</h1>
                    <div className="row border border-secondary rounded-pill my-4 mx-2 cursor">
                      <div className="col-md-2" onClick={handleGoogleSignIn}>
                          <img src="https://i.ibb.co/r75nsLd/google.png" className="imgSize" alt="googleLogo"/>
                      </div>
